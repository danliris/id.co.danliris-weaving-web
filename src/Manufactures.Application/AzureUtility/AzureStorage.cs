...
namespace Manufactures.Application.AzureUtility
{
    public class AzureStorage
    {
        ...
        public AzureStorage(IServiceProvider serviceProvider)
        {
            ...
            string storageAccountName = Infrastructure.External.DanLirisClient.CoreMicroservice.MasterDataSettings.StorageAccountName;
            string storageAccountKey = Infrastructure.External.DanLirisClient.CoreMicroservice.MasterDataSettings.StorageAccountKey;
