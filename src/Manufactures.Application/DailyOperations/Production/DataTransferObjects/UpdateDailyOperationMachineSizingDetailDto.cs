...
{
    public class UpdateDailyOperationMachineSizingDetailDto
    {
        ...
        public UpdateDailyOperationMachineSizingDetailDto(OrderDocument orderDocument, FabricConstructionDocument fabricConstructionDocument, DailyOperationMachineSizingDetail estimatedDetail)
        {
