...
{
    public class RemoveWeavingOrderDocumentCommandHandler : ICommandHandler<RemoveWeavingOrderCommand, WeavingOrderDocument>
    {
        private readonly IWeavingOrderDocumentRepository _weavingOrderDocumentRepository;
        private readonly IStorage _storage;

        public RemoveWeavingOrderDocumentCommandHandler(IStorage storage)
        {
            _storage = storage;
