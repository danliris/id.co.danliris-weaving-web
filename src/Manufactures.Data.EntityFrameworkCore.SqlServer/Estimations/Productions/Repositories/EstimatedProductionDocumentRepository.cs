...
{
    public class EstimatedProductionDocumentRepository : AggregateRepostory<EstimatedProductionDocument, EstimatedProductionDocumentReadModel>, IEstimatedProductionDocumentRepository
    {
