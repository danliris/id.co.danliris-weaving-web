...
namespace Manufactures.Domain.DailyOperations.Productions.Entities
{
    public class DailyOperationMachineSizingDetail : AggregateRoot<DailyOperationMachineSizingDetail, DailyOperationMachineSizingDetailReadModel>
    {
        ...
        public DailyOperationMachineSizingDetail(Guid identity,
                                         OrderId orderId, 
                                         ...
                                         Guid estimatedProductionDocumentId):base(identity)
        {
            ...
            ReadModel = new DailyOperationMachineSizingDetailReadModel(Identity)
            {
        ...
        public DailyOperationMachineSizingDetail(DailyOperationMachineSizingDetailReadModel readModel) : base(readModel)
        {
        ...
        protected override DailyOperationMachineSizingDetail GetEntity()
        {
            return this;
        }
    }
