...
namespace Manufactures.Domain.DailyOperations.Spu.Entities
{
    public class WeavingDailyOperationSpuMachine : AggregateRoot<WeavingDailyOperationSpuMachine, WeavingDailyOperationSpuMachineReadModel>
    {
        public WeavingDailyOperationSpuMachine(Guid identity) : base(identity)
        {
        }
        ...
        public WeavingDailyOperationSpuMachine(Guid identity, int Date,
          string Month,
          int MonthId,
          string Year,
          string YearPeriode,
          ...
          string Eff) : base(identity)
        {
            ...
            ReadModel = new WeavingDailyOperationSpuMachineReadModel(Identity)
            {
                Date = this.Date,
                Month = this.Month,
        ...
        public WeavingDailyOperationSpuMachine(WeavingDailyOperationSpuMachineReadModel readModel) : base(readModel)
        {
        ...
        protected override WeavingDailyOperationSpuMachine GetEntity()
        {
            return this;
        }
    }
