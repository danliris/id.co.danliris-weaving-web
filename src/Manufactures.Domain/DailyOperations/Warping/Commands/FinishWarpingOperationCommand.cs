...
{
    public class FinishWarpingOperationCommand
    ...
    public class FinishWarpingOperationCommandValidator
        : AbstractValidator<FinishWarpingOperationCommand>
    {
        public FinishWarpingOperationCommandValidator()
        {
