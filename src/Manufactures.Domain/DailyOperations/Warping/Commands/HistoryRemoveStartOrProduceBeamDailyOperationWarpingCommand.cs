...
{
    public class HistoryRemoveStartOrProduceBeamDailyOperationWarpingCommand : ICommand<DailyOperationWarpingDocument>
    {
    ...
    public class HistoryRemoveStartOrProduceBeamDailyOperationWarpingCommandValidator : AbstractValidator<HistoryRemoveStartOrProduceBeamDailyOperationWarpingCommand>
    {
        public HistoryRemoveStartOrProduceBeamDailyOperationWarpingCommandValidator()
        {
