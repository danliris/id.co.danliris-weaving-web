...
{
    public class PauseWarpingOperationCommand
    ...
    public class PauseWarpingOperationCommandValidator
        : AbstractValidator<PauseWarpingOperationCommand>
    {
        public PauseWarpingOperationCommandValidator()
        {
