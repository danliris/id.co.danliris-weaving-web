...
namespace Manufactures.Domain.Orders.ReadModels
{
    public class OrderReadModel : ReadModelBase
    {
        ...
        public Guid WarpOriginIdOne { get; internal set; }
        //public Guid? WarpOriginIdTwo { get; internal set; }
        ...
        public Guid WeftOriginIdOne { get; internal set; }
        public Guid? WeftOriginIdTwo { get; internal set; }
