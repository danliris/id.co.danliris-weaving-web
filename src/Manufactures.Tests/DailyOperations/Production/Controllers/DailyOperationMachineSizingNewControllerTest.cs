...
{
    public class DailyOperationMachineSizingNewControllerTest : BaseControllerUnitTest
    {
       ...
       // }
        ...
        //public DailyOperationLoomMachineController CreateDailyOperationMachineSizingNewController()
        //{
