...
{
    public class WeavingEstimatedProductionReportXlsTemplate
    {
        public MemoryStream GenerateXls(List<WeavingEstimatedProductionDto> machineDtos, string month, string yearPeriode)
        {
