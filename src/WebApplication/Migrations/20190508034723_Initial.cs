        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmtpyWeight = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizingOperatorId = table.Column<Guid>(nullable: false),
                    BeamId = table.Column<Guid>(nullable: false),
                    DailyOperationLoomHistory = table.Column<string>(maxLength: 2000, nullable: true),
                    WarpOrigin = table.Column<string>(nullable: true),
                    WeftOrigin = table.Column<string>(nullable: true),
